...
function ElementOne(props) {
  return (
    <div className="tw-flex md:tw-justify-center tw-align-middle ">
      ...
      <div className="tw-w-[90%] tw-ml-4  md:tw-w-1/2 tw-h-16 tw-rounded-full tw-bg-clion-dark-gray tw-my-6 tw-text-center md:tw-ml-10 tw-align-middle tw-py-4 tw-text-lg tw-font-bold">
        {props.item}
      </div>
    </div>
  )
